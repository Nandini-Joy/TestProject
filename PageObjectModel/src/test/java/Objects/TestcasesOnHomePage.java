...
public class TestcasesOnHomePage {
WebDriver driver;
	
	public TestcasesOnHomePage(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	By ShortOrBlue=By.xpath("//a[normalize-space()='shirt of blue']");
	...
	By Homefrompage=By.xpath("//a[@title='Go to Home Page']");
	   ...
	   public void SearchinHomepage(String Sear)
	   {
		   try {
	   ...
	   public void ShowDropdown()
	   {
		   try
		   {
			  ...
			  ShowPages.selectByVisibleText("24");
			  Thread.sleep(2000);
	 ...
	 public void ClickOnShortBlue()
	 {
		 try
		 {
			 driver.findElement(ShortOrBlue).click();
		 }
		 catch (Exception e)
		 {
			 System.out.println("Exception caught:"+ e.getMessage());
